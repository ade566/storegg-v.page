...
export default function MemberLayout(props: LayoutProps) {
  ...
  function menuCheck(thisClass: string) {
    const result = (classSection === thisClass) ? 'active' : '';
    return `${result} item mb-30`;
  }

  const menuActive = {
    overview: menuCheck('overview'),
    transactions: menuCheck((classSection === 'transactions-detail') ? 'transactions-detail' : 'transactions'),
    editProfile: menuCheck('edit-profile'),
  };
  return (
    <>
      <Head>
      ...
      <section className={section}>
        <section className="sidebar">
          <div className="content pt-50 pb-30 ps-30">
            ...
            <div className="menus">
              {/* overview */}
              <div className={menuActive.overview}>
              ...
              {/* transactions */}
              <div className={menuActive.transactions}>
                <svg className="icon me-3" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6.90332 2.41406L3.90332 6.41406V20.4141C3.90332 20.9445 4.11403 21.4532 4.48911 21.8283C4.86418 22.2033 5.37289 22.4141 5.90332 22.4141H19.9033C20.4338 22.4141 20.9425 22.2033 21.3175 21.8283C21.6926 21.4532 21.9033 20.9445 21.9033 20.4141V6.41406L18.9033 2.41406H6.90332Z" stroke="#7E8CAC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M16.9033 10.4141C16.9033 11.4749 16.4819 12.4923 15.7317 13.2425C14.9816 13.9926 13.9642 14.4141 12.9033 14.4141C11.8425 14.4141 10.825 13.9926 10.0749 13.2425C9.32475 12.4923 8.90332 11.4749 8.90332 10.4141" stroke="#7E8CAC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              ...
              <div className="item mb-30">
                <svg className="icon me-3" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clipPath="url(#clip0)">
                    <path d="M12.9033 15.4141C16.7693 15.4141 19.9033 12.2801 19.9033 8.41406C19.9033 4.54807 16.7693 1.41406 12.9033 1.41406C9.03733 1.41406 5.90332 4.54807 5.90332 8.41406C5.90332 12.2801 9.03733 15.4141 12.9033 15.4141Z" stroke="#7E8CAC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              ...
              <div className="item mb-30">
                <svg className="icon me-3" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19.2634 7.05396C20.5218 8.31274 21.3787 9.9164 21.7257 11.6621C22.0728 13.4079 21.8944 15.2173 21.2131 16.8617C20.5318 18.5061 19.3782 19.9115 17.8983 20.9003C16.4183 21.8891 14.6783 22.4169 12.8984 22.4169C11.1185 22.4169 9.37859 21.8891 7.89861 20.9003C6.41864 19.9115 5.26508 18.5061 4.58381 16.8617C3.90253 15.2173 3.72413 13.4079 4.07116 11.6621C4.41819 9.9164 5.27506 8.31274 6.53344 7.05396" stroke="#7E8CAC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
