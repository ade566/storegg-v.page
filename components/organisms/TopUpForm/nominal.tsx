...
export default function Nominal(props: NominalProps) {
  const { id, gold, nominal } = props;
      ...
      <div className="detail-card">
        <div className="d-flex justify-content-between">
          <p className="text-3xl color-palette-1 m-0">
            <span className="fw-medium">{gold}</span>
            Gold
          </p>
        ...
        <p className="text-lg color-palette-1 m-0">{nominal}</p>
      </div>
    </label>
  )
}
